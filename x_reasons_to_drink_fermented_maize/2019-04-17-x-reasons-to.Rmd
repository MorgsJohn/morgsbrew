...
author: "[Morgs Brew](https://github.com/MorgsBrew)"
date: "`r format(Sys.time(), '%d %B %Y')`"
mail: "morgsbrew@freshrots.co.za"
twitter: "MorgsBrew"
github: "MorgsBrew"
home: "www.freshrots.co.za"
# !!! You need to provide a logo image here !!! Or just delete the field for no logo
logo: "logo.png"
output: github_document 
# !!! Use -> output: <- to change the output 
# !!!  epuRate::epurate:
# !!!    toc: TRUE
...
```{r bib, echo = TRUE, message = FALSE, warning = FALSE}
...
When it comes to naming youtube videos there are certain conventions that work better than others. Some great examples of the most successful searches which seem to be inline with my thingking are:
